    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Users who engaged with your interactive tools</p>
        </div>
                ...
                leads.map((lead) => (
                  <tr key={lead.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="font-medium text-gray-900 dark:text-white">{lead.user_name}</div>
                      <div className="text-xs text-gray-500">{lead.user_email}</div>
                      {lead.user_phone && <div className="text-xs text-gray-400">{lead.user_phone}</div>}
                    </td>
                    <td className="px-6 py-4">
