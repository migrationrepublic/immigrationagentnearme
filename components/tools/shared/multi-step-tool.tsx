    ...
    return (
      <div className="max-w-3xl mx-auto p-6 bg-white rounded-2xl shadow-xl border border-gray-100">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900">Your Results are Ready!</h2>
          <p className="text-gray-500 mt-2">See your personalized analysis below.</p>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 flex justify-between items-center">
          ...
          <Button className="bg-brand-primary hover:bg-brand-primary/90 text-white px-8">
    ...
    <div className="max-w-3xl mx-auto" suppressHydrationWarning>
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden min-h-[400px] flex flex-col">
        <div className="p-8 md:p-12 flex-1">
          <h2 className="text-2xl md:text-3xl font-bold text-brand-primary mb-4">{step.question}</h2>
          {step.description && (
            ...
            {step.options?.map((option) => (
              ...
              >
                ...
                <ChevronRight className={`w-5 h-5 transition-transform ${
                  responses[step.id] === option.value ? 'translate-x-1 text-brand-accent' : 'text-gray-300 group-hover:text-gray-400'
                }`} />
              </button>
            ))}
          </div>
        ...
        <div className="px-8 py-6 bg-gray-50 border-t border-gray-100 flex justify-between">
          ...
          {step.type === 'input' && (
            <Button onClick={handleNext} className="bg-brand-primary hover:bg-brand-primary/90">
